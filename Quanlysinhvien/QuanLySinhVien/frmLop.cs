...
namespace QuanLySinhVien
{
    public partial class frmLop : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else if (txtMaLop.Text == dgrLop1.CurrentRow.Cells[1].Value.ToString())
            {
                errorProvider1.SetError(txtMaLop, "!");
        ...
        public void FillDataGridView_Lop()
        {
            ...
            dgrLop1.DataSource = DAO.DataProvider.Instance.ExecuteQuery(select);
            foreach (DataGridViewColumn column in dgrLop1.Columns)
            {
        ...
        private void dgrLop1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            selectedRow = e.RowIndex;
            if (selectedRow < 0) { return; }
            cboKhoa.Text = dgrLop1.CurrentRow.Cells[0].Value.ToString();
            txtMaLop.Text = dgrLop1.CurrentRow.Cells[1].Value.ToString();
            txtTenlop.Text = dgrLop1.CurrentRow.Cells[2].Value.ToString();
        }
        private void dgrLop1_FilterStringChanged(object sender, Zuby.ADGV.AdvancedDataGridView.FilterEventArgs e)
        {
            this.tblLOPBindingSource.Filter = this.dgrLop1.FilterString;
        }
    }
}
