...
namespace QuanLySinhVien
{
    public partial class frmKhoa : Form
    {
        ...
        public void FillDataGridView_Khoa()
        {
            ...
            dgrKhoa1.DataSource = DAO.DataProvider.Instance.ExecuteQuery(select);
            foreach (DataGridViewColumn column in dgrKhoa1.Columns)
            {
        ...
        private void dgrKhoa1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            selectedRow = e.RowIndex;
            if (selectedRow < 0) { return; }
            txtKhoa.Text = dgrKhoa1.CurrentRow.Cells[0].Value.ToString();
            txtTenKhoa.Text = dgrKhoa1.CurrentRow.Cells[1].Value.ToString();
        }
    }
}
