...
namespace QuanLySinhVien
{
    public partial class frmQLDiemHoclai : Form
    {
        ...
        public void FillDataGridView_Diem()
        {
            ...
            //// Đưa ra DataGridView
            //dgrDiem1.DataSource = ds;
            //dgrDiem1.DataMember = "SINHVIEN";
            //cmd.Dispose();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            //string select1 = "Select MaSV,TenMon from tblKET_QUA3 where TenMon=N'" + cboMonHoc.Text + "' ";
            //SqlCommand cmd1 = new SqlCommand(select1, conn);
            //SqlDataReader reader1 = cmd1.ExecuteReader();
            //errorProvider1.Clear();
            if (txtMaSV.Text == "")
        ...
        private void dgrDiem1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtDiemThi3.Text = dgrDiem1.CurrentRow.Cells[4].Value.ToString();
            cboHocKi.Text = dgrDiem1.CurrentRow.Cells[5].Value.ToString();
        }
    }
}
